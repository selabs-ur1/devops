...
public class MealPreferenceResource {
    ...
    public ResponseEntity<Object> getAllMealPreferencesFromPoll(@PathVariable String slug) throws JsonMappingException, JsonProcessingException, ConnectionException, IOException, InterruptedException {
    ...
    public ResponseEntity<Object> getMealPreferenceFromPoll(@PathVariable String slug, @PathVariable long idMealPreference) throws JsonMappingException, JsonProcessingException, ConnectionException, IOException, InterruptedException{
        System.out.println("polls/{slug}/mealpreference/{idMealPreference}");
    ...
    public ResponseEntity<Object> createMealPreference(@Valid @RequestBody MealPreference mealPreference, @PathVariable String slug, @PathVariable long idUser) throws JsonMappingException, JsonProcessingException, ConnectionException, IOException, InterruptedException{
        System.out.println("polls/{slug}/mealpreference/{idUser}");
